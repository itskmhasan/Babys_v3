export const storeCustomization = {
  ...
  home: {
    ...
    quick_delivery_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from Babys | Best Shop for Moms and Babies and get some special offers. See Our latest discounted products from here and get a special discount.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus Babys | Best Shop for Moms and Babies und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
    },
    ...
    daily_need_title: {
      en: "Get Your Daily Needs From Our Babys | Best Shop for Moms and Babies Store",
      de: "Holen Sie sich Ihren täglichen Bedarf in unserem Babys | Best Shop for Moms and Babies Shop",
    },
    daily_need_description: {
      en: "There are many products you will find in our shop, Choose your daily necessary product from Babys | Best Shop for Moms and Babies and get some special offers.",
      de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus Babys | Best Shop for Moms and Babies und erhalten Sie einige Sonderangebote.",
    },
  ...
  about_us: {
    ...
    top_title: {
      en: "Welcome to Babys | Best Shop for Moms and Babies",
      de: "Willkommen bei Babys | Best Shop for Moms and Babies",
    },
    top_description: {
  ...
  faq: {
    ...
    faq_one: {
      en: "How does Babys | Best Shop for Moms and Babies work?",
      de: "Wie funktioniert Babys | Best Shop for Moms and Babies?",
    },
    description_one: {
    ...
    faq_five: {
      en: "What is Babys | Best Shop for Moms and Babies EC2 auto scaling?",
      de: "Was ist die automatische Skalierung von Babys | Best Shop for Moms and Babies EC2?",
    },
    description_five: {
      en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
  ...
  seo: {
    ...
    meta_title:
      "Babys | Best Shop for Moms and Babies",
