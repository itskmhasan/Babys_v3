...
import logoDark from "@/assets/img/logo/babys_logo_lq8wPwi.png";
import logoLight from "@/assets/img/logo/babys_logo_lq8wPwi.png";
  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a className=" text-gray-900 dark:text-gray-200" href="/dashboard">
        {theme === "dark" ? (
          <img src={logoLight} alt="babys" width="135" className="pl-6" />
        ) : (
          <img src={logoDark} alt="babys" width="135" className="pl-6" />
        )}
      </a>
      <ul className="mt-8">
