...
const forgetPassword = async (req, res) => {
  ...
  if (!isAdded) {
    ...
    const body = {
      ...
      <p>A request has been received to change the password for your <strong>Babys</strong> account </p>
        ...
        <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at ${process.env.EMAIL_USER || "support@babys.com.bd"}</p>

        <p style="margin-bottom:0px;">Thank you</p>
        <strong>Babys Team</strong>
             `,
    };
